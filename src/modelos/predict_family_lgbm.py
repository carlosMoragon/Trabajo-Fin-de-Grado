...
lgbm_model = joblib.load("../../src/modelos/modelo2/modelo_lgbm.pkl")  # Cargar el modelo LightGBM
...
def objective(trial):
    config = {
        ...
        "ph2": config_json['ph2'],
        "column": {
            "uspCode": config_json['column']['uspCode'],
            "length": config_json['column']['length'],
            "particleSize": config_json['column']['particleSize'],
            "temperature": config_json['column']['temperature'],
            "flowrate": config_json['column']['flowrate'],
            "t0": config_json['column']['t0'],
            "name": config_json['column']['name']
        },
        "gradient": {
            "x0": config_json['gradient']['x0'],
