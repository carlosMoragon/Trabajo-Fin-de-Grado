...
def objective(trial):
    config = {
        "Eluent1": config_json['config']['eluent1'],
        "Eluent2": config_json['config']['eluent2'],
        "pH1": config_json['config']['ph1'],
        "pH2": config_json['config']['ph2'],
        "USP_Code": config_json['config']['column']['uspCode'],
        "Length": config_json['config']['column']['length'],
        "Particle_Size": config_json['config']['column']['particleSize'],
        "Temperature": config_json['config']['column']['temperature'],
        "Flow": config_json['config']['column']['flowrate'],
        "T0": config_json['config']['column']['t0'],
        "Duration": config_json['config']['gradient']['duration'],
        "x1": config_json['config']['gradient']['x1'],
        "x2": config_json['config']['gradient']['x2'],
        "x3": config_json['config']['gradient']['x3'],
        "x4": config_json['config']['gradient']['x4'],
        "x5": config_json['config']['gradient']['x5'],
        "x6": config_json['config']['gradient']['x6'],
        "x7": config_json['config']['gradient']['x7'],
        "x8": config_json['config']['gradient']['x8'],
        "x9": config_json['config']['gradient']['x9'],
        "x10": config_json['config']['gradient']['x10'],
        "Intercept": config_json['config']['gradient']['intercept'],
